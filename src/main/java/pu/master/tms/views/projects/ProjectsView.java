package pu.master.tms.views.projects;
...
public class ProjectsView extends VerticalLayout {
    ...
    private void openProjectDialog(ProjectDto project) {
        ...
        taskGrid.addColumn(TaskDto::getTitle).setHeader("Task Title").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(task -> task.getOwnerUsername()).setHeader("Owner").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(TaskDto::getPriorityLevel).setHeader("Priority Level").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(TaskDto::getStatus).setHeader("Status").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(TaskDto::getDateCreated).setHeader("Date Created").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(TaskDto::getDateLastModified).setHeader("Date Last Modified").setSortable(true).setAutoWidth(true);
        taskGrid.addColumn(TaskDto::getDateDue).setHeader("Date Due").setSortable(true).setAutoWidth(true);
        ...
        taskButtonLayout.setJustifyContentMode(FlexComponent.JustifyContentMode.BETWEEN); // "New Task" on left, "Delete Tasks" on right
        ...
        // Create the "Save" and "Delete Project" buttons
        Button saveButton = new Button("Save");
        saveButton.setWidth("80px"); // Fixed size for "Save" button

        Button deleteProjectButton = new Button(VaadinIcon.TRASH.create());
        deleteProjectButton.setWidth("80px"); // Fixed size for "Delete" button
        ...
        bottomButtonLayout.setJustifyContentMode(FlexComponent.JustifyContentMode.BETWEEN); // Align buttons to the left and right

        // Add buttons to the layout with left and right alignment
        bottomButtonLayout.add(saveButton); // "Save" button on the left
        bottomButtonLayout.add(deleteProjectButton); // "Delete" button on the right

        // Wrap everything in a scrollable layout
        VerticalLayout dialogContent = new VerticalLayout(titleField, descriptionField, dueDateField, userComboBox, taskLayout, bottomButtonLayout);
